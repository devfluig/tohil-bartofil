<div id="campanha_vendas_${instanceId}" class="super-widget wcm-widget-class fluig-style-guide" data-params="campanhavendas.instance({instanceId: ${instanceId}, foldercampanha: '${foldercampanha!''}' })">
