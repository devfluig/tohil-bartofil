function createDataset(fields, constraints, sortFields) {
	...
	/*	var order = "codcampanha";
	if (sortFields != null) {
		for (o in sortFields) {
			order = (order == "codcampanha" ? sortFields[o] : order + "," + sortFields[o])
		}
	}
	*/
	try {
...
/*        var clientService = fluigAPI.getAuthorizeClientService();
        var data = {
            ...
            serviceCode : 'RCA',
            endpoint : "/v1/campanha?sessionid=123abc&codrepresentante=" + representante + "&order=" + order + "&offset=" + offset + "&limit=" + limit,
            method : 'get',     
            timeoutService: '1000',
	        options : {
...
//            var result = JSON.parse(vo.getResult());
    	...
    	dataset.addRow(new Array("erro", "Sem comissão para o periodo solicitado", "", "", "", "", "", "", "", "", "", "", "", "", "")); 
    }
