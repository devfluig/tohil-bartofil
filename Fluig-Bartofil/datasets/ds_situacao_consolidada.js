...
//		log.info("ds_comissoes")
        ...
        var data = {
            ...
            serviceCode : 'RCA',
            endpoint : "/v1/representante/" + representante + "/pedidos?sessionid=123abc&datainclusaoinicio=" + datainicio + "&datainclusaofim=" + datafim + "&resume=S&situacao=A,F,L,R,S,W&fields=situacao",
            method : 'get',     
            timeoutService: '1000',
	        options : {
